...
void TR_BitVector::print(TR::Logger *log, TR::Compilation *comp) { comp->getDebug()->print(log, this); }

void TR_SingleBitContainer::print(TR::Logger *log, TR::Compilation *comp) { comp->getDebug()->print(log, this); }
