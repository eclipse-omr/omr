...
static TR::Register*
compressExpandBitsEvaluator(TR::Node *node, TR::CodeGenerator *cg, TR::InstOpCode::Mnemonic regRegRegOpCode, TR::InstOpCode::Mnemonic regRegMemOpCode)
   {
...
static TR::Register*
smallCompressBitsEvaluator(TR::Node *node, TR::CodeGenerator *cg, const bool isShort)
   {
   // bcompressbits and scompressbits require special logic to handle zero-extension
   TR_ASSERT_FATAL(node->getDataType() == TR::Int16 || node->getDataType() == TR::Int8, "smallCompressBitsEvaluator only supports 16, or 8 bits");
   ...
   if (maskMR)
      ...
      cg->stopUsingRegister((resReg == maskReg) ? srcReg : maskReg);
      }
...
OMR::X86::TreeEvaluator::bcompressbitsEvaluator(TR::Node *node, TR::CodeGenerator *cg)
   {
   return smallCompressBitsEvaluator(node, cg, false);
   }

TR::Register*
OMR::X86::TreeEvaluator::scompressbitsEvaluator(TR::Node *node, TR::CodeGenerator *cg)
   {
   return smallCompressBitsEvaluator(node, cg, true);
   }

TR::Register*
OMR::X86::TreeEvaluator::icompressbitsEvaluator(TR::Node *node, TR::CodeGenerator *cg)
   {
   return compressExpandBitsEvaluator(node, cg, TR::InstOpCode::PEXT4RegRegReg, TR::InstOpCode::PEXT4RegRegMem);
   }

TR::Register*
OMR::X86::TreeEvaluator::lcompressbitsEvaluator(TR::Node *node, TR::CodeGenerator *cg)
   {
   return compressExpandBitsEvaluator(node, cg, TR::InstOpCode::PEXT8RegRegReg, TR::InstOpCode::PEXT8RegRegMem);
   }

TR::Register*
OMR::X86::TreeEvaluator::bexpandbitsEvaluator(TR::Node *node, TR::CodeGenerator *cg)
   {
   return iexpandbitsEvaluator(node, cg);
   }
...
OMR::X86::TreeEvaluator::iexpandbitsEvaluator(TR::Node *node, TR::CodeGenerator *cg)
   {
   return compressExpandBitsEvaluator(node, cg, TR::InstOpCode::PDEP4RegRegReg, TR::InstOpCode::PDEP4RegRegMem);
   }

TR::Register*
OMR::X86::TreeEvaluator::lexpandbitsEvaluator(TR::Node *node, TR::CodeGenerator *cg)
   {
   return compressExpandBitsEvaluator(node, cg, TR::InstOpCode::PDEP8RegRegReg, TR::InstOpCode::PDEP8RegRegMem);
   }
