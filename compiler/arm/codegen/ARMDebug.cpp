...
void TR_Debug::print(TR::Logger *log, TR::ARMLabelInstruction *instr)
{
    printPrefix(log, instr);
...
#ifdef J9_PROJECT_SPECIFIC
void TR_Debug::print(TR::Logger *log, TR::ARMVirtualGuardNOPInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::ARMAdminInstruction *instr)
{
...
void TR_Debug::print(TR::Logger *log, TR::ARMImmInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::ARMImmSymInstruction *instr)
{
...
void TR_Debug::print(TR::Logger *log, TR::ARMTrg1Src2Instruction *instr)
{
#if (defined(__VFP_FP__) && !defined(__SOFTFP__))
...
#if (defined(__VFP_FP__) && !defined(__SOFTFP__))
void TR_Debug::print(TR::Logger *log, TR::ARMTrg2Src1Instruction *instr)
{
    // fmrrd
...
void TR_Debug::print(TR::Logger *log, TR::ARMMulInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", fullOpCodeName(instr));
...
void TR_Debug::print(TR::Logger *log, TR::ARMMemSrc1Instruction *instr)
{
...
void TR_Debug::print(TR::Logger *log, TR::ARMTrg1Instruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", fullOpCodeName(instr));
...
void TR_Debug::print(TR::Logger *log, TR::ARMMemInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", fullOpCodeName(instr));
    print(log, instr->getMemoryReference());
...
void TR_Debug::print(TR::Logger *log, TR::ARMTrg1MemInstruction *instr)
{
    if (instr->getBinaryEncoding() && instr->getMemoryReference()->hasDelayedOffset()
        && !instr->getMemoryReference()->getUnresolvedSnippet()) {
        TR::InstOpCode::Mnemonic op = instr->getOpCodeValue();
...
void TR_Debug::print(TR::Logger *log, TR::ARMTrg1MemSrc1Instruction *instr)
{
    // strex
    printPrefix(log, instr);
    log->printf("%s\t", fullOpCodeName(instr));
...
void TR_Debug::print(TR::Logger *log, TR::ARMControlFlowInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", fullOpCodeName(instr));
...
void TR_Debug::print(TR::Logger *log, TR::ARMMultipleMoveInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s\t", fullOpCodeName(instr));
...
void TR_Debug::printARMHelperBranch(TR::Logger *log, TR::SymbolReference *symRef, uint8_t *bufferPos,
...
void TR_Debug::print(TR::Logger *log, TR_ARMOperand2 *op, TR_RegisterSizes size)
{
    switch (op->_opType) {
...
void TR_Debug::printARMGCRegisterMap(TR::Logger *log, TR::GCRegisterMap *map)
{
    TR::Machine *machine = _cg->machine();
...
void TR_Debug::printa(TR::Logger *log, TR::Snippet *snippet)
{
    switch (snippet->getKind()) {
        case TR::Snippet::IsCall:
...
void TR_Debug::print(TR::Logger *log, TR::ARMCallSnippet *snippet)
{
...
void TR_Debug::print(TR::Logger *log, TR::ARMUnresolvedCallSnippet *snippet)
{
#ifdef J9_PROJECT_SPECIFIC
...
void TR_Debug::print(TR::Logger *log, TR::ARMVirtualUnresolvedSnippet *snippet)
{
#ifdef J9_PROJECT_SPECIFIC
...
void TR_Debug::print(TR::Logger *log, TR::ARMInterfaceCallSnippet *snippet)
{
#ifdef J9_PROJECT_SPECIFIC
    TR::SymbolReference *callSymRef = snippet->getNode()->getSymbolReference();
...
void TR_Debug::print(TR::Logger *log, TR::ARMHelperCallSnippet *snippet)
{
#ifdef J9_PROJECT_SPECIFIC
    uint8_t *bufferPos = snippet->getSnippetLabel()->getCodeLocation();
...
void TR_Debug::print(TR::Logger *log, TR::ARMStackCheckFailureSnippet *snippet)
{
    uint8_t *bufferPos = snippet->getSnippetLabel()->getCodeLocation();
    printSnippetLabel(log, snippet->getSnippetLabel(), bufferPos, getName(snippet));
...
#ifdef J9_PROJECT_SPECIFIC
void TR_Debug::print(TR::Logger *log, TR::UnresolvedDataSnippet *snippet)
{
...
void TR_Debug::print(TR::Logger *log, TR::ARMRecompilationSnippet *snippet)
{
#ifdef J9_PROJECT_SPECIFIC
...
void TR_Debug::printARMDelayedOffsetInstructions(TR::Logger *log, TR::ARMMemInstruction *instr)
{
    bool regSpilled;
    uint8_t *bufferPos = instr->getBinaryEncoding();
    int32_t offset = instr->getMemoryReference()->getOffset();
