...
//#define STAYINFP
   ...
   if ((node->getSymbolReference()->getSymbol()->isVolatile() || node->getSymbolReference()->getSymbol()->isAcqRel()) &&
...
TR::Register *OMR::ARM::TreeEvaluator::i2fEvaluator(TR::Node *node, TR::CodeGenerator *cg)
   ...
   if (firstChild->getReferenceCount() == 1 &&
      ...
      !((firstChild->getSymbolReference()->getSymbol()->isVolatile() || firstChild->getSymbolReference()->getSymbol()->isAcqRel()) && cg->comp()->target().isSMP()))
      {
