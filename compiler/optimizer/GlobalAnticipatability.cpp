...
TR_GlobalAnticipatability::TR_GlobalAnticipatability(TR::Compilation *comp, TR::Optimizer *optimizer,
...
bool TR_GlobalAnticipatability::isExceptionalInBlock(TR::Node *node, int32_t blockNumber, ContainerType *alreadyInBlock,
    vcount_t visitCount)
{
