    ...
    int32_t otherRelative, OMR::ValuePropagation *vp)
{
    ...
    constraint = TR::VPNotEqual::create(vp, newIncr);
    if (vp->trace()) {
        vp->comp()->getLogger()->printf("      Propagating V != value %d %+d and V == value %d %+d", relative,
...
void TR::VPNullObject::print(TR::Logger *log, TR::Compilation *comp) { log->prints(" (NULL)"); }

void TR::VPNonNullObject::print(TR::Logger *log, TR::Compilation *comp) { log->prints(" (non-NULL)"); }

void TR::VPPreexistentObject::print(TR::Logger *log, TR::Compilation *comp) { log->prints(" (pre-existent)"); }
...
void TR::VPUnreachablePath::print(TR::Logger *log, TR::Compilation *comp) { log->prints("*** Unreachable Path ***"); }
