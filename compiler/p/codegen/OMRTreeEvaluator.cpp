...
TR::Register *OMR::Power::TreeEvaluator::s2mEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
    ...
    TR_ASSERT_FATAL(child->getDataType().getVectorElementType() == TR::Int64,
        "Unsupported vector type %s for s2m (must be Int64)\n", child->getDataType().getVectorElementType().toString());
