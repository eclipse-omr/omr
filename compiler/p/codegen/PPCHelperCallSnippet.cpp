...
void TR_Debug::print(TR::Logger *log, TR::PPCHelperCallSnippet *snippet)
{
...
uint8_t *TR_Debug::print(TR::Logger *log, TR::PPCArrayCopyCallSnippet *snippet, uint8_t *cursor)
{
