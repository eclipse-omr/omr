...
public:
    ...
    void insertStoresForDeadStackSlots(TR::Compilation *comp, TR_ByteCodeInfo &byteCodeInfo, TR::TreeTop *insertTree,
    ...
    int matchInduceOSRCall(TR::TreeTop *insertionPoint, int16_t callerIndex, int16_t byteCodeIndex,
    ...
    TR::TreeTop *genInduceOSRCall(TR::TreeTop *insertionPoint, int32_t inlinedSiteIndex,
        ...
        TR::CFG *cfg = NULL);
    TR::TreeTop *genInduceOSRCallAndCleanUpFollowingTreesImmediately(TR::TreeTop *insertionPoint,
    ...
    bool supportsInduceOSR(TR_ByteCodeInfo &bci, TR::Block *blockToOSRAt, TR::Compilation *comp,
