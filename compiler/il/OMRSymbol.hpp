...
public:
   ...
   enum MemoryOrdering
      ...
      OpaqueSemantics,         ///< Accesses to opaque symbols are bitwise atomic. The execution order of all opaque
      ...
      AcquireReleaseSemantics, ///< Acquire/release symbols have all the same guarantees and constraints as opaque symbols.
      ...
      VolatileSemantics,       ///< Volatile symbols have all the same guarantees and constraints as acquire/release symbols.
