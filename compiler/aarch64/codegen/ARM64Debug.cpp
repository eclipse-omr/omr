...
void TR_Debug::print(TR::Logger *log, TR::ARM64ImmInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::ARM64RelocatableImmInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::ARM64ImmSymInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::ARM64LabelInstruction *instr)
{
    printPrefix(log, instr);
...
#ifdef J9_PROJECT_SPECIFIC
void TR_Debug::print(TR::Logger *log, TR::ARM64VirtualGuardNOPInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::ARM64ConditionalBranchInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::ARM64CompareBranchInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::ARM64TestBitBranchInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::ARM64RegBranchInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::ARM64AdminInstruction *instr)
{
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1Instruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1CondInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1ImmInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
    print(log, instr->getTargetRegister(), TR_WordReg);
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1ImmShiftedInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
    print(log, instr->getTargetRegister(), TR_WordReg);
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1ImmSymInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
    print(log, instr->getTargetRegister(), TR_WordReg);
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1Src1Instruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1ZeroSrc1Instruction *instr)
{
    printPrefix(log, instr);
    TR::InstOpCode::Mnemonic op = instr->getOpCodeValue();
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1Src1ImmInstruction *instr)
{
    printPrefix(log, instr);
    TR::InstOpCode::Mnemonic op = instr->getOpCodeValue();
    bool done = false;
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1ZeroImmInstruction *instr)
{
    printPrefix(log, instr);
    TR::InstOpCode::Mnemonic op = instr->getOpCodeValue();
    bool done = false;
...
void TR_Debug::print(TR::Logger *log, TR::ARM64ZeroSrc1ImmInstruction *instr)
{
    printPrefix(log, instr);
    TR::InstOpCode::Mnemonic op = instr->getOpCodeValue();
    bool done = false;
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1Src2Instruction *instr)
{
    printPrefix(log, instr);
    TR::InstOpCode::Mnemonic op = instr->getOpCodeValue();
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::ARM64ZeroSrc2Instruction *instr)
{
    printPrefix(log, instr);
    TR::InstOpCode::Mnemonic op = instr->getOpCodeValue();
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Src1ImmCondInstruction *instr)
{
    printPrefix(log, instr);
    TR::InstOpCode::Mnemonic op = instr->getOpCodeValue();
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Src2CondInstruction *instr)
{
    printPrefix(log, instr);
    TR::InstOpCode::Mnemonic op = instr->getOpCodeValue();
...
void TR_Debug::print(TR::Logger *log, TR::ARM64SynchronizationInstruction *instr)
{
    printPrefix(log, instr);
    const char *lim
...
void TR_Debug::print(TR::Logger *log, TR::ARM64CondTrg1Src2Instruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1Src2ImmInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1Src2ShiftedInstruction *instr)
{
    printPrefix(log, instr);
    TR::InstOpCode::Mnemonic op = instr->getOpCodeValue();
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1Src2ExtendedInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1Src2IndexedElementInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1Src2ZeroInstruction *instr)
{
    printPrefix(log, instr);
    TR::InstOpCode::Mnemonic op = instr->getOpCodeValue();
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1Src3Instruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
    print(log, instr->getTargetRegister(), TR_WordReg);
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1MemInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg2MemInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::ARM64MemInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
    print(log, instr->getMemoryReference());
...
void TR_Debug::print(TR::Logger *log, TR::ARM64MemImmInstruction *instr)
{
    TR::InstOpCode::Mnemonic op = instr->getOpCodeValue();
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::ARM64MemSrc1Instruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::ARM64MemSrc2Instruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Trg1MemSrc1Instruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Src1Instruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
    print(log, instr->getSource1Register(), TR_WordReg);
...
void TR_Debug::print(TR::Logger *log, TR::ARM64Src2Instruction *instr)
{
    printPrefix(log, instr);
    log->printf("%s \t", getOpCodeName(&instr->getOpCode()));
    print(log, instr->getSource1Register(), TR_WordReg);
...
void TR_Debug::print(TR::Logger *log, TR::MemoryReference *mr)
{
    log->printc('[');
...
void TR_Debug::printARM64GCRegisterMap(TR::Logger *log, TR::GCRegisterMap *map)
{
...
void TR_Debug::printa64(TR::Logger *log, TR::Snippet *snippet)
{
    switch (snippet->getKind()) {
#ifdef J9_PROJECT_SPECIFIC
        case TR::Snippet::IsCall:
