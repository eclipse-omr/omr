...
void TR_Debug::printz(TR::Logger *log, TR::Instruction *instr, const char *title) { printz(log, instr); }

void TR_Debug::printz(TR::Logger *log, TR::Instruction *instr)
{
...
void TR_Debug::dumpDependencies(TR::Logger *log, TR::Instruction *instr, bool pre, bool post)
{
...
void TR_Debug::printAssocRegDirective(TR::Logger *log, TR::Instruction *instr)
{
...
void TR_Debug::print(TR::Logger *log, TR::S390RRSInstruction *instr)
{
...
void TR_Debug::print(TR::Logger *log, TR::S390IEInstruction *instr)
{
    printPrefix(log, instr);
 ...
 *   "Opcode  R1,I2 (mask=)"
 */
void TR_Debug::print(TR::Logger *log, TR::S390RIEInstruction *instr)
{
 ...
 */
void TR_Debug::print(TR::Logger *log, TR::S390RISInstruction *instr)
{
    // print opcode
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
...
void TR_Debug::print(TR::Logger *log, TR::S390LabelInstruction *instr)
{
...
#ifdef J9_PROJECT_SPECIFIC
void TR_Debug::print(TR::Logger *log, TR::S390VirtualGuardNOPInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::S390BranchInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::S390BranchOnCountInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::S390BranchOnIndexInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::S390AnnotationInstruction *instr)
{
    log->prints(instr->getAnnotation());
    log->flush();
}

void TR_Debug::print(TR::Logger *log, TR::S390PseudoInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
...
void TR_Debug::print(TR::Logger *log, TR::S390ImmInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::S390Imm2Instruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::S390ImmSnippetInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s0x%08x", OPCODE_SPACING, instr->getOpCode().getMnemonicName(), instr->getSourceImmediate());
    log->flush();
...
void TR_Debug::print(TR::Logger *log, TR::S390ImmSymInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s0x%08x", OPCODE_SPACING, instr->getOpCode().getMnemonicName(), instr->getSourceImmediate());
    log->flush();
...
void TR_Debug::print(TR::Logger *log, TR::S390RegInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::S390RRInstruction *instr)
{
    int32_t i = 1;
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
...
void TR_Debug::print(TR::Logger *log, TR::S390TranslateInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
...
void TR_Debug::print(TR::Logger *log, TR::S390RRFInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::S390RRRInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
...
void TR_Debug::print(TR::Logger *log, TR::S390RIInstruction *instr)
{
...
void TR_Debug::print(TR::Logger *log, TR::S390RILInstruction *instr)
{
    uint8_t *cursor = (uint8_t *)instr->getBinaryEncoding();
...
void TR_Debug::print(TR::Logger *log, TR::S390RSLInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
    print(log, instr->getMemoryReference(), instr);
...
//
////////////////////////////////////////////////////////////////////////////
void TR_Debug::print(TR::Logger *log, TR::S390RSLbInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
...
void TR_Debug::print(TR::Logger *log, TR::S390RSInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
...
void TR_Debug::print(TR::Logger *log, TR::S390MemInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
 ...
 */
void TR_Debug::print(TR::Logger *log, TR::S390SSEInstruction *instr)
{
    // print opcode
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
 ...
 */
void TR_Debug::print(TR::Logger *log, TR::S390SS1Instruction *instr)
{
    // print opcode
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
 ...
 */
void TR_Debug::print(TR::Logger *log, TR::S390SS2Instruction *instr)
{
    // print opcode
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
 ...
 */
void TR_Debug::print(TR::Logger *log, TR::S390SS4Instruction *instr)
{
    // print opcode
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
 ...
 */
void TR_Debug::print(TR::Logger *log, TR::S390SSFInstruction *instr)
{
    // print opcode
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
 ...
 */
void TR_Debug::print(TR::Logger *log, TR::S390SIInstruction *instr)
{
    // print opcode
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
 ...
 */
void TR_Debug::print(TR::Logger *log, TR::S390SILInstruction *instr)
{
    // print opcode
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
 ...
 */
void TR_Debug::print(TR::Logger *log, TR::S390SInstruction *instr)
{
    // print opcode
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
...
void TR_Debug::print(TR::Logger *log, TR::S390OpCodeOnlyInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
    log->flush();
...
void TR_Debug::print(TR::Logger *log, TR::S390IInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::print(TR::Logger *log, TR::S390RXInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
    if (instr->getRegisterOperand(1)->getRegisterPair()) {
...
void TR_Debug::print(TR::Logger *log, TR::S390RXEInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
    print(log, instr->getRegisterOperand(1));
...
void TR_Debug::print(TR::Logger *log, TR::S390RXFInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
    print(log, instr->getRegisterOperand(1));
...
void TR_Debug::print(TR::Logger *log, TR::S390MIIInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
...
void TR_Debug::print(TR::Logger *log, TR::S390SMIInstruction *instr)
{
    printPrefix(log, instr);
    log->printf("%-*s", OPCODE_SPACING, instr->getOpCode().getMnemonicName());
    log->printf("(mask=0x%1x), ", instr->getMask());
...
void TR_Debug::print(TR::Logger *log, TR::MemoryReference *mr, TR::Instruction *instr)
{
...
void TR_Debug::printSymbolName(TR::Logger *log, TR::Symbol *sym, TR::SymbolReference *symRef, TR::MemoryReference *mr)
{
    char *str;
    bool sawWCodeName = false;
...
void TR_Debug::print(TR::Logger *log, TR::S390NOPInstruction *instr)
{
    printPrefix(log, instr);
    log->prints("NOP");
    log->flush();
...
void TR_Debug::print(TR::Logger *log, TR::S390AlignmentNopInstruction *instr)
{
    printPrefix(log, instr);
...
void TR_Debug::printS390GCRegisterMap(TR::Logger *log, TR::GCRegisterMap *map)
{
...
uint8_t *TR_Debug::printS390ArgumentsFlush(TR::Logger *log, TR::Node *node, uint8_t *bufferPos, int32_t argSize)
{
...
void TR_Debug::printGPRegisterStatus(TR::Logger *log, TR::Machine *machine)
{
...
void TR_Debug::printFPRegisterStatus(TR::Logger *log, TR::Machine *machine)
{
...
void TR_Debug::printS390RegisterDependency(TR::Logger *log, TR::Register *virtReg, int realReg, bool refsReg,
    bool defsReg)
{
...
void TR_Debug::printRegisterDependencies(TR::Logger *log, TR::RegisterDependencyGroup *rgd, int numberOfRegisters)
{
    if (rgd == NULL) {
        return;
    }
...
uint8_t *TR_Debug::printLoadVMThreadInstruction(TR::Logger *log, uint8_t *cursor) { return cursor; }

uint8_t *TR_Debug::printRuntimeInstrumentationOnOffInstruction(TR::Logger *log, uint8_t *cursor, bool isRION,
 ...
 */
void TR_Debug::print(TR::Logger *log, TR::S390VRIInstruction *instr)
{
    printPrefix(log, instr);
 ...
 */
void TR_Debug::print(TR::Logger *log, TR::S390VRRInstruction *instr)
{
    printPrefix(log, instr);
 ...
 */
void TR_Debug::print(TR::Logger *log, TR::S390VStorageInstruction *instr)
{
    printPrefix(log, instr);
