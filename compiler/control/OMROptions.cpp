...
TR::OptionTable OMR::Options::_jitOptions[] = {
    ...
    { "enableAPXExtendedGPRs", "O\tAllow the use of r16-r31 for Intel APX", SET_OPTION_BIT(TR_EnableAPXExtendedGPRs),
     "F", NOT_IN_SUBSET },
    { "enableAVX512ExtendedRegs", "O\tAllow the use of xmm16-xmm31 for Intel AVX512F",
     SET_OPTION_BIT(TR_EnableAVX512ExtendedRegs), "F", NOT_IN_SUBSET },
