...
TR::OptionTable OMR::Options::_jitOptions[] = {
    ...
    { "disableRetryCodeCacheAllocAndIgnoreKind", "M\tDisable retrying code cache allocation when kind cannot be respected",
     SET_OPTION_BIT(TR_DisableRetryCodeCacheAllocAndIgnoreKind), "F", NOT_IN_SUBSET },
