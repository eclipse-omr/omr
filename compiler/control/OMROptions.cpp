...
TR::OptionTable OMR::Options::_jitOptions[] = {
    ...
    { "restrictStaticFieldFolding", "O\trestrict instance field folding", SET_OPTION_BIT(TR_RestrictStaticFieldFolding),
     "F" },
    { "alwaysObeyCodeCacheKind", "M\tDisable retrying code cache allocation when kind cannot be respected",
     SET_OPTION_BIT(TR_AlwaysObeyCodeCacheKind), "F", NOT_IN_SUBSET },
