...
enum TR_CompilationOptions {
    // The enum values in this enum use one hot encoding. Therefore, it is much
    // easier to read (and more importantly add) the option bits when it is
    // right-aligned. As such, prevent clang-format from changing the
